                        ...
                        <div className="bg-white px-4 sm:px-6 py-4 sm:py-6">
                            ...
                            <div className="hidden md:block border border-gray-200 overflow-x-auto rounded">
                                <table className="w-full border-collapse">
                                    ...
                                    <tbody className="bg-white">
                                        ...
                                        <tr>
                                            <td colSpan="4" className="py-4 px-4 bg-white">
                                                <button 
                                                    className="bg-red-500 text-white px-6 py-2 rounded text-sm hover:bg-red-600"
                            ...
                            <div className="md:hidden space-y-4">
                                ...
                                <div className="bg-white border border-gray-300 rounded-lg p-4">
                                    <button 
                                        className="bg-red-500 text-white px-6 py-2 rounded text-sm hover:bg-red-600 w-full"
                                        onClick={handleDeleteSelected}
                                        disabled={selectedRows.length === 0}
                                    >
                                        Delete
